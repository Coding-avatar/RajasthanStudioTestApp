class PexelImageApiResponseModel {
  int page;
  int perPage;
  List<Photos> photos;
  int totalResults;
  ...
  PexelImageApiResponseModel.fromJson(Map<String, dynamic> json) {
    page = json['page'];
    perPage = json['per_page'];
    if (json['photos'] != null) {
      photos = new List<Photos>.empty(growable: true);
