class PexelVideoApiResponseModel {
  int page;
  int perPage;
  List<Videos> videos;
  int totalResults;
  ...
  PexelVideoApiResponseModel.fromJson(Map<String, dynamic> json) {
    page = json['page'];
    perPage = json['per_page'];
    if (json['videos'] != null) {
      videos = new List<Videos>.empty(growable: true);
...
class Videos {
  ...
  Videos.fromJson(Map<String, dynamic> json) {
    ...
    if (json['tags'] != null) {
      tags = new List<Null>.empty(growable: true);
      json['tags'].forEach((v) {
        tags.add(v);
      });
    }
    ...
    if (json['video_files'] != null) {
      videoFiles = new List<VideoFiles>.empty(growable: true);
      json['video_files'].forEach((v) {
        videoFiles.add(new VideoFiles.fromJson(v));
      });
    }
    if (json['video_pictures'] != null) {
      videoPictures = new List<VideoPictures>.empty(growable: true);
